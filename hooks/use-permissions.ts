...
function getRoleBasedPermissions(role: "admin" | "staff" | "attendee"): Permission[] {
  const basePermissions: Record<string, Permission> = {
    ...
    'conferences.edit': { id: 5, code: 'conferences.edit', name: 'Chỉnh sửa Hội nghị' },
    'conferences.update': { id: 6, code: 'conferences.update', name: 'Cập nhật Hội nghị' },
    'conferences.delete': { id: 7, code: 'conferences.delete', name: 'Xóa Hội nghị' },
    'conferences.manage': { id: 8, code: 'conferences.manage', name: 'Quản lý Hội nghị' },
    'conferences.export': { id: 9, code: 'conferences.export', name: 'Xuất dữ liệu Hội nghị' },
    'attendees.view': { id: 10, code: 'attendees.view', name: 'Xem Người tham dự' },
    'attendees.read': { id: 11, code: 'attendees.read', name: 'Đọc Người tham dự' },
    'attendees.write': { id: 12, code: 'attendees.write', name: 'Ghi Người tham dự' },
    'attendees.manage': { id: 13, code: 'attendees.manage', name: 'Quản lý Người tham dự' },
    'checkin.manage': { id: 14, code: 'checkin.manage', name: 'Quản lý Check-in' },
    'roles.manage': { id: 15, code: 'roles.manage', name: 'Quản lý Phân quyền' },
